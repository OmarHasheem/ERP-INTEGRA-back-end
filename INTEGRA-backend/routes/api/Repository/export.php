...
Route::controller(ExportController::class)->group(function () {
    Route::prefix('repository')->group(function (){
        ...
        Route::get('/exports/{id}', 'show')->middleware('permission:store export');
        Route::post('/exports', 'store')->middleware('permission:show export');
        Route::put('/export/{id}', 'update')->middleware('permission:update export');
