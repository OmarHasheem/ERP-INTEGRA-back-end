...
Route::controller(ExportProductDetailController::class)->group(function () {
    Route::prefix('repository')->group(function (){
        ...
        Route::get('/prdoctsExports/{id}', 'show');
        Route::get('/prdoctsExports', 'index');
        Route::post('/prdoctsExports', 'store');
        Route::put('/prdoctsExports/{id}', 'update');
        Route::delete('/prdoctsExports/{id}', 'destroy');

        Route::get('/prdoctsExports/productsByExportId/{id}', 'productsByExportId');
    });
});
