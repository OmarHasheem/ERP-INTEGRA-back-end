...
Route::controller(EmployeeCertificateController::class)->group(function () {
    Route::prefix('hr')->group(function (){
        ...
        Route::get('/employeeCertificates/{id}', 'show');        
        Route::get('/employeeCertificates', 'index');
        Route::post('/employeeCertificates', 'store');
        Route::put('/employeeCertificates/{id}', 'update');
        Route::delete('/employeeCertificates/{id}', 'destroy');
    });
});
