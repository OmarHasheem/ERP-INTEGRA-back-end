...
Route::controller(EmployeePerformanceController::class)->group(function () {
    Route::prefix('hr')->group(function (){
        ...
        Route::get('/employeePerformances/{id}', 'show');        
        Route::get('/employeePerformances', 'index');
        Route::post('/employeePerformances', 'store');
        Route::put('/employeePerformances/{id}', 'update');
        Route::delete('/employeePerformances/{id}', 'destroy');
    });
});
