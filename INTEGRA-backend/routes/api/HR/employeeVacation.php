...
Route::controller(EmployeeVacationController::class)->group(function () {
    Route::prefix('hr')->group(function (){
        ...
        Route::get('/employeeVacations/{id}', 'show');        
        Route::get('/employeeVacations', 'index');
        Route::post('/employeeVacations', 'store');
        Route::put('/employeeVacations/{id}', 'update');
        Route::delete('/employeeVacations/{id}', 'destroy');
    });
});
